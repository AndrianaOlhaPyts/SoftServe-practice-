...
namespace Cinema.Data
{
    public class DatabaseInitializer
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            if (!await _context.Halls.AnyAsync(h => h.Name == "2 Hall"))
            {
                ...
                var hall = new Hall
                {
                    ...
                    Rows = new List<Row>
                    {
                        ...
                        CreateRow(1, 9, "standard", hallId),
                        CreateRow(2, 9, "standard", hallId),
                        CreateRow(3, 9, "standard", hallId),
                        CreateRow(4, 9, "standard", hallId),

                        // Один ряд із VIP розсадкою, 8 VIP місць
                        CreateRow(5, 6, "vip", hallId),

                        // Один ряд зі змішаною розсадкою: 9 стандартних місць, 2 місця для інвалідів
                        CreateRow(6, 7, "standard", hallId, 2, "accessible")
                    }
                };
